  ...
  return (
    <div>
        <div className='px-4 pt-40 lg:px-40 space-y-4 pb-28'>
            ...
            {/* section 1 */}
            <div>
                <h2 className='text-blue-700 text-xl'>ABSCHNITT 1 - BEDINGUNGEN FÜR DIE PLATTFORM</h2>
            ...
            {/* section 2 */}
            <div>
                <h2 className='text-blue-700 text-xl'>ABSCHNITT 2 - ALLGEMEINE BEDINGUNGEN</h2>
            ...
            {/* section 3 */}
            <div>
                <h2 className='text-blue-700 text-xl'>ABSCHNITT 3 - GENAUIGKEIT, VOLLSTÄNDIGKEIT UND RECHTZEITIGKEIT DER INFORMATIONEN</h2>
            ...
            {/* section 4 */}
            <div>
                <h2 className='text-blue-700 text-xl'>ABSCHNITT 4 - ÄNDERUNGEN AN DER LEISTUNG UND DEN PREISEN</h2>
                <p>Die Preise für unsere Produkte / Dienstleistungen können ohne vorherige Ankündigung geändert werden.</p>
                <br></br>
                ...
                <br></br>
                <p>Cryptocheck24 ist weder Ihnen noch Dritten gegenüber haftbar für Änderungen, Preisänderungen, Sperrung oder Einstellung des Serviceleistung.</p>
            </div>

            {/* section 5 */}
            <div>
                <h2 className='text-blue-700 text-xl'>ABSCHNITT 5 - PRODUKTE ODER SERVICELEISTUNGEN </h2>
                <p>Gewisse Produkte oder Serviceleistungen sind möglicherweise nur online über die Website erhältlich. Diese Produkte oder Serviceleistungen sind unter Umständen nur in begrenzten Mengen vorhanden und unterliegen nur einer Stornierung gemäß unseren Rückgaberichtlinien.</p>
                <br></br>
                <p>Wir haben uns bemüht, die Farben und Bilder unserer Partner und Serviceleistungen, die auf der Website erscheinen, so genau wie möglich darzustellen. Wir können nicht garantieren, dass Ihr Computerbildschirm jede Farbe korrekt anzeigt.
                    Wir behalten uns das Recht vor, sind aber nicht verpflichtet, den Verkauf unserer Produkte oder Serviceleistungen auf gewisse Personen, geografische Regionen oder Gerichtsbarkeiten zu beschränken. Wir können dieses Recht von Fall zu Fall ausüben. Wir behalten uns das Recht vor, die Mengen der von uns angebotenen Produkte oder Serviceleistungen zu begrenzen. Alle Beschreibungen und Preise können jederzeit ohne Vorankündigung und nach unserem alleinigen Ermessen geändert werden. Wir behalten uns das Recht vor, jedes Produkt oder Unternehmen jederzeit aus dem Angebot zu nehmen. Jedes Angebot für ein Produkt oder eine Serviceleistung, das auf dieser Website gemacht wird, ist ungültig, wo es verboten ist.</p>
                <br></br>
                <p>Wir garantieren nicht, dass die Qualität von Produkten, Serviceleistungen, Informationen oder anderen Materialien, die von Ihnen gekauft, eingesehen oder erworben wurden, Ihren Erwartungen entspricht, oder dass Fehler in der Serviceleistung korrigiert werden.</p>
            </div>

            {/* section 6 */}
            {/* <div>
                <h2 className='text-blue-700 text-xl'>ABSCHNITT 6 - RICHTIGKEIT DER RECHNUNGS- UND KONTOINFORMATIONEN</h2>
                <p>Wir behalten uns das Recht vor, jegliche Bestellung und / oder Anfrage, die Sie bei uns aufgeben, abzulehnen. Wir können nach eigenem Ermessen die Abnahmemengen pro Person, pro Haushalt oder pro Bestellung begrenzen oder stornieren. Diese Einschränkungen können Bestellungen umfassen, die von oder unter demselben Kundenkonto oder derselben Kreditkarte aufgegeben wurden und/oder Bestellungen, die dieselbe Rechnungs- und/oder Lieferadresse verwenden. Falls wir eine Bestellung ändern oder stornieren, werden wir versuchen, Sie zu benachrichtigen, indem wir die E-Mail und/oder die Rechnungsadresse/Telefonnummer kontaktieren, die zum Zeitpunkt der Bestellung angegeben wurde. Wir behalten uns das Recht vor, Bestellungen einzuschränken oder zu verbieten, die nach unserem alleinigen Ermessen den Anschein erwecken, von Händlern, Wiederverkäufern oder Distributoren aufgegeben worden zu sein.
            ...
            <div>
                ...
                <p>Diese Allgemeinen Geschäftsbedingungen sowie von uns auf dieser Website oder in Bezug auf die Serviceleistung veröffentlichten Richtlinien oder Betriebsvorschriften, stellen die gesamte Vereinbarung und Übereinkunft zwischen Ihnen und uns dar, regeln Ihre Nutzung der Serviceleistung und ersetzen alle vorherigen oder gleichzeitigen Vereinbarungen, Mitteilungen und Angebote, mündlich oder schriftlich, zwischen Ihnen und uns (einschließlich, aber nicht beschränkt auf vorherige Versionen der Allgemeinen Geschäftsbedingungen).
                    Etwaige Unklarheiten bei der Auslegung dieser Allgemeinen Geschäftsbedingungen sind nicht gegen die verfassende Partei zu verstehen.</p>
            </div>
