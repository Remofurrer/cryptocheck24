  ...
  return (
    <div>
        <div className='px-4 pt-40 lg:px-40 space-y-4 pb-28'>
            ...
            {/* section 3 */}
            <div>
                <h2 className='text-blue-700 text-xl'>WIE VERWENDEN WIR IHRE PERSONENBEZOGENEN DATEN?</h2>
                <p>Wir verwenden die von uns erfassten informationen in der Regel zur Bearbeitung von Anfragen jeglicher Art, Spenden oder Bestellungen von Produkten und/oder Services, die wir über die Website erhalten (unter anderem zur Verarbeitung Ihrer Zahlungsinformationen und Zusendung von Rechnungen und/oder Bestellbestätigungen).</p>
                <br></br>
                <p>  Außerdem verwenden wir diese Bestellinformation zur:</p>
                <br></br>
                <p>Kommunikation mit Ihnen;</p>
                <p>Prüfung unserer Bestellungen auf potenzielle Risiken oder Betrug und</p>
                <br></br>
                <p> Bereitstellung von Informationen oder Werbung im Zusammenhang mit unseren Produkten oder Dienstleistungen an Sie, sofern dies mit Ihren Datenschutzeinstellungen im Einklang steht.
                    ...
                    WEITERGABE IHRER PERSONENBEZOGEN DATEN</p>
                <br></br>
            ...
            {/* section 5 */}
            <div>
                <h2 className='text-blue-700 text-xl'>IHRE RECHTE</h2>
                <p>Wenn Sie in Europa ansässig sind, haben Sie das Recht, auf die personenbezogenen Daten, die wir über Sie besitzen, zuzugreifen und deren Korrektur, Aktualisierung oder Löschung zu fordern. Wenn Sie dieses Recht ausüben möchten, setzen Sie sich über die nachstehenden Kontaktdaten mit uns in Verbindung.
                    Wenn Sie in Europa ansässig sind, weisen wir außerdem darauf hin, dass wir Ihre Daten verarbeiten, um Verträge mit Ihnen zu erfüllen (z. B. wenn Sie über die Website eine Bestellung aufgeben) oder um unsere oben genannten berechtigten Geschäftsinteressen zu verfolgen.  Bitte beachten Sie außerdem, dass Ihre Daten außerhalb von Europa, einschließlich Kanada und den Vereinigten Staaten, übertragen werden.</p>
            </div>

            {/* section 6 */}
            <div>
                <h2 className='text-blue-700 text-xl'>AUFBEWAHRUNG VON DATEN</h2>
                <p>Wenn Sie einen Service über die Website aufgeben, bewahren wir Ihre Informationen für unsere Aufzeichnungen auf, sofern Sie uns nicht auffordern, diese Daten zu löschen.</p>
            </div>

            {/* section 7 */}
            <div>
                <h2 className='text-blue-700 text-xl'>ÄNDERUNGEN</h2>
                <p>Wir können diese Datenschutzerklärung gelegentlich ändern, um Änderungen unserer Vorgehensweisen zu berücksichtigen, oder aus anderen betrieblichen, rechtlichen oder aufsichtsrechtlichen Gründen.</p>
            </div>
