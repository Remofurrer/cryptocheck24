    ...
    <div>
        ...
        <div className='flex flex-col justify-center items-center md:px-10 lg:flex-row lg:space-x-4 pb-28'>
            ...
            <div class="my-4 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="p-5">
                    <a href="">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Ledger Live</h5>
                    </a>
                    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Die Cold Wallets von Ledger Live gehören zu den besten und sichersten weltweit. Bewahren Sie ihre Kryptowährungen sicher auf.</p>
                    <a href="https://shop.ledger.com?r=2aaf1e1eedba" class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Partner besuchen
