...
<footer ref={ref} className="p-4 bg-white sm:p-6">
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                ...
                <ul className="text-gray-600 dark:text-gray-400 space-y-4">
                    <Link href="/donate">
                    <li>
                        <a className=" cursor-pointer hover:underline">Spenden</a>
                    </li>
                    </Link>
                    <Link href="/member">
                    <li>
                        <a href="https://tailwindcss.com/" className="hover:underline">Mitglied werden</a>
                    </li>
                    </Link>
                    <li>
                        <a href="/recommend" className="hover:underline">Wir empfehlen</a>
                    </li>
                </ul>
            </div>
            <div>
                ...
                <ul className="text-gray-600 dark:text-gray-400 space-y-4">
                    <Link href="/about">
                    <li>
                        <a href="https://github.com/themesberg/flowbite" className="hover:underline ">Über Cryptocheck24</a>
                    </li>
                    </Link>
                    <Link href="/news">
                    <li>
                        <a href="https://discord.gg/4eeurUVvTy" className="hover:underline">News</a>
                    </li>
                    </Link>
                    <Link href="/contact">
                    <li>
                        <a href="https://discord.gg/4eeurUVvTy" className="hover:underline">Kontakt</a>
                    </li>
                    </Link>
                </ul>
            </div>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com/" className="hover:underline">Cryptocheck24</a>. Alle Rechte vorbehalten.
        </span>
